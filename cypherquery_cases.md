...
### Run below cases using the below workbook, a kinetica workbench jupyter SQL notebook
* Load [Graph Workbook](./workbooks/Graph%20Workbooks.json) into your free Kinetica-Workbench (either on-prem Dev-Edition or freeSaaS)
* [Get Free on PREM Developer Edition](https://www.kinetica.com/kinetica-developer-edition/)   
---
